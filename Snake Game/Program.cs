...
namespace Snake_Game
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Coord applePos = new Coord(random.Next(1, gridDimensions.X - 1),
                random.Next(1, gridDimensions.Y - 1));
            int frameDelayMilli = 125;
            int score = 0;
            ...
            while (true)
            {
                ...
                snakePos.ApplyMovmentDirection(movementDirection);
                ...
                if (snakePos.Equals(applePos))
                {
                    tailLength++;
                    score++;
                    applePos = new Coord(random.Next(1, gridDimensions.X - 1),
                        random.Next(1, gridDimensions.Y - 1));
                }
